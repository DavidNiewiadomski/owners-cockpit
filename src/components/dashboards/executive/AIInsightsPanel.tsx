...
const AIInsightsPanel: React.FC<AIInsightsPanelProps> = ({ projectData }) => {
  ...
  const insights = {
    ...
    keyFindings: [
      `Project completion at ${projectData.progress}% with budget performance ${budgetUtilizationNum > 100 ? 'over' : 'under'} target`,
    ...
    recommendations: [
      ...
      budgetUtilizationNum > 95 ? 'Monitor budget closely to prevent overruns' : 'Maintain current budget discipline',
